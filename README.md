...
The latest stable version of Graylog is **`5.2.0-rc.1`**.
...
|---|---|---|
| OpenJDK 17 | `linux/amd64`, `linux/arm64` | `5.2.0-rc.1-2` |
...
The latest stable version is **`5.2-rc.1`**, with support for Java 17 on platform `linux/amd64` and `linux/arm64`.

| Java Version  | Platform  | Tags  |
|---|---|---|
| OpenJDK 17 | `linux/amd64`, `linux/arm64` | `5.2-rc.1`, `forwarder-5.2-rc.1-1` |
