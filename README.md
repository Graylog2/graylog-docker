...
The latest stable version of Graylog is **`7.1.4`**.
...
|---|---|---|
| OpenJDK 21 | `linux/amd64`, `linux/arm64` | `7.1`, `7.1.4`, `7.1.4-1` |
...
The latest stable version is **`7.4`**, with support for Java 21 on platform `linux/amd64` and `linux/arm64`.

| Java Version  | Platform  | Tags  |
|---|---|---|
| OpenJDK 21 | `linux/amd64`, `linux/arm64` | `7.4`, `forwarder-7.4-1` |
