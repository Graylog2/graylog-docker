...
The latest stable version of Graylog is **`4.1.13`**.
...
|---|---|---|
| OpenJDK 8  | `linux/amd64`, `linux/arm64` | `4.1`, `4.1.13`, `4.1.13-1` |
| OpenJDK 11  | `linux/amd64`, `linux/arm64`  | `4.1-jre11`, `4.1.13-jre11`, `4.1.13-1-jre11`  |
...
| Java Version  | Platform  | Tags  |
|---|---|---|
| OpenJDK 8  | `linux/amd64` | `4.1`, `4.1.13`, `4.1.13-1` |
| OpenJDK 11  | `linux/amd64` | `4.1-jre11`, `4.1.13-jre11`, `4.1.13-1-jre11`  |
