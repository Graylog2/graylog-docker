...
The latest stable version of Graylog is **`5.1.0-rc.2`**.
...
|---|---|---|
| OpenJDK 17 | `linux/amd64`, `linux/arm64` | `5.1.0-rc.2-1` |
...
The latest stable version is **`5.1-rc.1`**, with support for Java 17 on platform `linux/amd64` and `linux/arm64`.

| Java Version  | Platform  | Tags  |
|---|---|---|
| OpenJDK 17 | `linux/amd64`, `linux/arm64` | `5.1-rc.1`, `forwarder-5.1-rc.1-1` |
