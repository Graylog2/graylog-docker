...
The latest stable version of Graylog is **`6.0.0-alpha.1`**.
...
|---|---|---|
| OpenJDK 17 | `linux/amd64`, `linux/arm64` | `6.0.0-alpha.1-1` |
...
The latest stable version is **`5.2`**, with support for Java 17 on platform `linux/amd64` and `linux/arm64`.

| Java Version  | Platform  | Tags  |
|---|---|---|
| OpenJDK 17 | `linux/amd64`, `linux/arm64` | `5.2`, `forwarder-5.2-1` |
