...
The latest stable version of Graylog is **`6.3.0`**.
...
|---|---|---|
| OpenJDK 17 | `linux/amd64`, `linux/arm64` | `6.3`, `6.3.0`, `6.3.0-1` |
...
The latest stable version is **`6.5-rc.2`**, with support for Java 17 on platform `linux/amd64` and `linux/arm64`.

| Java Version  | Platform  | Tags  |
|---|---|---|
| OpenJDK 17 | `linux/amd64`, `linux/arm64` | `6.5-rc.2`, `forwarder-6.5-rc.2-1` |
