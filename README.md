...
The latest stable version of Graylog is **`5.0.0-beta.1`**.
...
|---|---|---|
| OpenJDK 17 | `linux/amd64`, `linux/arm64` | `5.0.0-beta.1-1` |
...
The latest stable version is **`4.10`**, with support for Java 17 on platform `linux/amd64` and `linux/arm64`.

| Java Version  | Platform  | Tags  |
|---|---|---|
| OpenJDK 17 | `linux/amd64`, `linux/arm64` | `4.10`, `forwarder-4.10-1` |
