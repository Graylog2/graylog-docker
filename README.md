...
The latest development version of Graylog is **`7.0.0-beta.4`**.
...
|---|---|---|
| OpenJDK 21 | `linux/amd64`, `linux/arm64` | `7.0.0-beta.4-1` |
...
The latest stable version is **`7.0-beta.4`**, with support for Java 21 on platform `linux/amd64` and `linux/arm64`.

| Java Version  | Platform  | Tags  |
|---|---|---|
| OpenJDK 21 | `linux/amd64`, `linux/arm64` | `7.0-beta.4`, `forwarder-7.0-beta.4-1` |
