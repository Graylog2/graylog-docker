...
The latest stable version of Graylog is **`6.0.0-alpha.3`**.
...
|---|---|---|
| OpenJDK 17 | `linux/amd64`, `linux/arm64` | `6.0.0-alpha.3-1` |
...
The latest stable version is **`6.0-alpha.1`**, with support for Java 17 on platform `linux/amd64` and `linux/arm64`.

| Java Version  | Platform  | Tags  |
|---|---|---|
| OpenJDK 17 | `linux/amd64`, `linux/arm64` | `6.0-alpha.1`, `forwarder-6.0-alpha.1-1` |
