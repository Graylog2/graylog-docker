...
Latest stable version of Graylog is *3.2.1* this Version is available with the tags `3.2` or `3.2.1-1`.
...
Use the stable `3.2` release for your production environments. Please check the [latest stable documentation](http://docs.graylog.org/en/stable/pages/installation/docker.html) for complete installation and configuration instruction.
