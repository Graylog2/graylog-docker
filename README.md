...
The latest stable version of Graylog is **`7.0.0`**.
...
|---|---|---|
| OpenJDK 21 | `linux/amd64`, `linux/arm64` | `7.0`, `7.0.0`, `7.0.0-1` |
...
The latest stable version is **`7.0-rc.2`**, with support for Java 21 on platform `linux/amd64` and `linux/arm64`.

| Java Version  | Platform  | Tags  |
|---|---|---|
| OpenJDK 21 | `linux/amd64`, `linux/arm64` | `7.0-rc.2`, `forwarder-7.0-rc.2-1` |
