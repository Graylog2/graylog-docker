...
The latest stable version is **`7.0-rc.1`**, with support for Java 21 on platform `linux/amd64` and `linux/arm64`.

| Java Version  | Platform  | Tags  |
|---|---|---|
| OpenJDK 21 | `linux/amd64`, `linux/arm64` | `7.0-rc.1`, `forwarder-7.0-rc.1-1` |
