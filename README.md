...
The latest stable version of Graylog is **`7.1.8`**.
...
|---|---|---|
| OpenJDK 21 | `linux/amd64`, `linux/arm64` | `7.1`, `7.1.8`, `7.1.8-1` |
...
| Java Version  | Platform  | Tags  |
|---|---|---|
| OpenJDK 21 | `linux/amd64`, `linux/arm64` | `7.5`, `forwarder-7.5-1` |
