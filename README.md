...
The latest development version of Graylog is **`7.0.0-alpha.2`**.
...
|---|---|---|
| OpenJDK 21 | `linux/amd64`, `linux/arm64` | `7.0.0-alpha.2-2` |
...
The latest stable version is **`6.5-beta.3`**, with support for Java 21 on platform `linux/amd64` and `linux/arm64`.

| Java Version  | Platform  | Tags  |
|---|---|---|
| OpenJDK 21 | `linux/amd64`, `linux/arm64` | `6.5-beta.3`, `forwarder-6.5-beta.3-1` |
