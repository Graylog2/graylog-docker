...
Latest stable version of Graylog is *3.3.0* this Version is available with the tags `3.3` or `3.3.0-1`.
...
Use the stable `3.3` release for your production environments. Please check the [latest stable documentation](http://docs.graylog.org/en/3.2/pages/installation/docker.html) for complete installation and configuration instruction.
