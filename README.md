...
The latest devlopment version of Graylog is **`7.0.0-alpha.2`**.
...
|---|---|---|
| OpenJDK 17 | `linux/amd64`, `linux/arm64` | `7.0.0-alpha.2-1` |
...
The latest stable version is **`6.5-beta.3`**, with support for Java 17 on platform `linux/amd64` and `linux/arm64`.

| Java Version  | Platform  | Tags  |
|---|---|---|
| OpenJDK 17 | `linux/amd64`, `linux/arm64` | `6.5-beta.3`, `forwarder-6.5-beta.3-1` |
