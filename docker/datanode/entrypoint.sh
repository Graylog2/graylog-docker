...
export GRAYLOG_DATANODE_OPENSEARCH_PLUGINS_LOCATION="${GRAYLOG_DATANODE_OPENSEARCH_PLUGINS_LOCATION:-"$GDN_APP_ROOT/dist/plugins"}"
export GRAYLOG_DATANODE_OPENSEARCH_HTTP_PORT="9200"
export GRAYLOG_DATANODE_OPENSEARCH_TRANSPORT_PORT="9300"
